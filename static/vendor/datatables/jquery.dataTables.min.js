...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"first",sLast:"last",sNext:"next",sPrevious:"previous"},sEmptyTable:"Atualmente não há dados na tabela!",sInfo:"Exibindo _START_ a _END_ de _TOTAL_ itens",sInfoEmpty:"Exibindo 0 a 0 de 0 itens",
sInfoFiltered:"(Filtrando a partir de _MAX_ itens)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"_MENU_ Itens",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"Pesquisar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nenhum registro correspondente encontrado!"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
